# -*- coding: utf-8 -*-
"""two_gram_single.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ihE85iF9SKwwUkbmM7ljWNN1U8C8kc29
"""
...
def model2(filter_kernels, dense_outputs, maxlen, vocab_size, nb_filter,cat_output):                                                  # For Character Embedding use this model instead of above model
    ...
    conv4 = MaxPooling1D()(conv1)
#    conv4= Capsule(num_capsule=1 ,dim_capsule=72, routings=1,share_weights=True)(conv1)
    #conv2 = MaxPooling1D()(conv2)

#    conv4 = LSTM(100)(conv1)
...
#    conv4 = GRU(100)(conv1)
    ...
    pred = Dense(cat_output, activation='softmax', name='output')(conv5)
