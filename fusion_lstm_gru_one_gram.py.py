...
# email_data = pd.read_csv('/content/Emails authors.csv')
email_data = pd.read_csv('MAIL_20.csv')
print(email_data.head(10))
...
# dataset_50=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/50_tweets_per_user_train.csv')
# dataset_100=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/100_tweets_per_user_train.csv')
# dataset_200=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/200_tweets_per_user_train.csv')
# dataset_500=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/500_tweets_per_user_train.csv')
# dataset_1000=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/1000_tweets_per_user_train.csv')
# dataset_30=pd.read_csv('/Data/chanchal_1821cs11/Rohit_CS/New/final_Dataset/30_real_users_final.csv')
#dataset_30 = pd.read_csv('30_real_users_final.csv')
X_train, X_test, y_train, y_test = train_test_split(tester_data['text'], tester_data['authors'], test_size=0.33, random_state=0)

X_train_ml, X_test_ml, y_train_ml, y_test_ml = train_test_split(email_data['Text'], email_data['label'], test_size=0.33, random_state=0)
print(X_train.shape,y_train.shape,X_test.shape,y_test.shape)
#print(dataset_30.shape)
print(X_train_ml.shape,y_train_ml.shape,X_test_ml.shape,y_test_ml.shape)
#print(data.shape)
#print(dataset.shape)
'''
k=0
...
y_train_ml=pd.DataFrame(y_train_ml)
y_test_ml=pd.DataFrame(y_test_ml)
...
X_train_ml=X_train_ml.iloc[:,:].values
X_test_ml=X_test_ml.iloc[:,:].values
y_train_ml=y_train_ml.iloc[:,:].values
y_test_ml=y_test_ml.iloc[:,:].values
...
train_ml=np.concatenate((X_train_ml,y_train_ml),axis=1)
test_ml=np.concatenate((X_test_ml,y_test_ml),axis=1)

print('Tweet: Train and Test size = ', train.shape, test.shape)
print('Mail: Train and Test size = ', train_ml.shape, test_ml.shape)

np.random.shuffle(train)
np.random.shuffle(test)

np.random.shuffle(train_ml)
np.random.shuffle(test_ml)
...
print('Mail: Train and Test size = ', train.shape, test.shape)
X_ml = train_ml[train_ml.columns[0]]
y_ml = train_ml[train_ml.columns[1:]]
print(X_ml.shape)
print(y_ml.shape)
...
X_train_ml, X_test_ml, y_train_ml, y_test_ml = train_test_split(X_ml, y_ml, test_size=0.33, random_state=42)
print(X_train_ml.shape,y_train_ml.shape,X_test_ml.shape,y_test_ml.shape)
...
def model2(filter_kernels, dense_outputs, maxlen, vocab_size, nb_filter,cat_output):
    ...
    #conv3 = Convolution1D(filters=nb_filter, kernel_size=filter_kernels[3], activation='relu',input_shape=(maxlen, vocab_size))(inputs)
...
#    conv4= Capsule(num_capsule=1 ,dim_capsule=72, routings=1,share_weights=True)(conv4)
    ...
    #conv2 = LSTM(100)(conv2)
#    conv3 = LSTM(100)(conv3)
#    conv4 = LSTM(100)(conv4)
